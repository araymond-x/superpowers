...
pattern_references:
  - name: "prompt-template-structure"
    source_files: ["skills/subagent-driven-development/spec-reviewer-prompt.md"]
    reason: "Prompt template structure, dispatch example format, output format"
  - name: "verification-role"
    source_files: ["skills/subagent-driven-development/pre-execution-audit-prompt.md"]
    reason: "Independent verification role, cross-referencing pattern"
  - name: "file-gate-pattern"
    source_files: ["skills/subagent-driven-development/scripts/sdd-pre-dispatch-hook.sh"]
    reason: "File gate pattern (Check 5c checkpoint gate)"
tasks:
  - id: 1
    title: "Extract Content and Add Partner Workflow to SDD SKILL.md"
  - id: 2
    title: "Create Controller Partner Prompt Template"
  - id: 3
    title: "Write Partner Review Gate Tests (TDD Red Phase)"
  - id: 4
    title: "Add Partner Review Gate to Pre-Dispatch Hook"
    depends_on: [3]
  - id: 5
