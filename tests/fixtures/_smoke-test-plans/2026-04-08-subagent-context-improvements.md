...
tasks:
  - id: 1
    title: "Add Shared Constants Field to Plan Header Template"
  - id: 2
    title: "Add Shared Constants Ingestion and Passthrough to SDD SKILL"
    depends_on: [1]
  - id: 3
    title: "Add Shared Constants Section to Implementer Prompt Template"
    depends_on: [2]
  - id: 4
    title: "Add Import Assertion Step to Task 0 Template"
  - id: 5
    title: "Add Fix Complexity Gate to Systematic Debugging Skill"
  - id: 6
