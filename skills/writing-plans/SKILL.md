...
- Complete code in plan (not "add validation") — vague instructions leave the implementation decision to the subagent, who has no context about your validation patterns or error message formats.
